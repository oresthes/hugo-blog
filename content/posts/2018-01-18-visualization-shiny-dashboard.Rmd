...
To help visualize general trends and our modeling efforts I built the an interactive tool using Shiny (see below). Due to the data bein proprietary, I am using a very small set accounts and vendors spread over two cities. Additionally, names of accounts and vendors have been replaced by random numbers. 

The original data contains hundreds of accounts and vendors spread over more than 10 cities. It is at this scale that the utility of the tool becomes more important, as it allowed the team to dig down to individual cases very quickly.
...
Three different plots are produced which can be accessed by using the tabs at the top. 
    ...
    - The *Vendor-Peformance* tab isolates only events associated to the selected vendor-account pair.  
